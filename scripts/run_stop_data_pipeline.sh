...
if [[ "$INCREMENTAL_PRODUCTION" == "1" || "$INCREMENTAL_NO_ACTIVATE" == "1" ]]; then
  ...
  export HALTEWECKER_EXTERNAL_BUILD_CACHE_PROVIDERS="${HALTEWECKER_EXTERNAL_BUILD_CACHE_PROVIDERS:-cta-chicago},israel-mot,ttc-surface,ttc-subway"
  export HALTEWECKER_EXTERNAL_DEPARTURES_V3_PROVIDERS="israel-mot,ttc-surface,ttc-subway"
  ...
  export HALTEWECKER_EXTERNAL_DEPARTURE_CACHE_PROVIDERS="${HALTEWECKER_EXTERNAL_DEPARTURE_CACHE_PROVIDERS:-cta-chicago},israel-mot,ttc-surface,ttc-subway"
